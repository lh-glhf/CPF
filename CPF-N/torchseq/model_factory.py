...
from .exps.exp_trendNbeats import Exp_trendNbeats
...
Training_Models = ['Informer', 'Autoformer', 'FEDformer', 'ModernTCN', 'PatchTST', 'Crossformer', 'iTransformer', 'iInformer', 'iReformer', 'iFlowformer', 'NLinear', 'DLinear', 'MICN',
                   'TimesNet', 'LSTM', 'RNN', 'SCINet', 'Nbeats', 'trendNbeats', 'GPT4changePoints']
...
def create_model(
    ...
    elif args.model == 'GPT4changePoints':
        print("unique data")
    if args.model == 'MICN':
