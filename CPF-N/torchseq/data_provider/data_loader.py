...
class Dataset_Custom(Dataset):
    ...
    def __read_data__(self):
        ...
        df_stamp = df_raw[['date']][border1:border2]
        df_changePoints = df_raw[['changePoints']][border1: border2]
        df_stamp['date'] = pd.to_datetime(df_stamp.date).apply(lambda x: x.timestamp())
        # if self.timeenc == 0:
        #     df_stamp['month'] = df_stamp.date.apply(lambda row: row.month, 1)
        #     df_stamp['day'] = df_stamp.date.apply(lambda row: row.day, 1)
        #     df_stamp['weekday'] = df_stamp.date.apply(lambda row: row.weekday(), 1)
        ...
        self.data_changePoints = df_changePoints.values
    ...
    def __getitem__(self, index):
        ...
        seq_x_mark = self.data_stamp[s_begin:s_end]
        seq_y_mark = self.data_stamp[r_begin:r_end]
        seq_x_changePoints = self.data_changePoints[s_begin:s_end]
        seq_y_changePoints = self.data_changePoints[r_begin:r_end]
        return seq_x, seq_y, seq_x_mark, seq_y_mark, seq_x_changePoints, seq_y_changePoints
