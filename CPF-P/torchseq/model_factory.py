...
from .exps.exp_UniTS_pretrain import Exp_UniTS_pretrain
from .exps.exp_UniTS_sup import Exp_UniTS_sup
from .exps.exp_ANN import Exp_ANN
...
model_entrypoints = {
    ...
    'Nbeats': Exp_Nbeats,
    'Arima': Exp_Arima,
    'UniTS_pretrain': Exp_UniTS_pretrain,
    'UniTS_sup': Exp_UniTS_sup,
    'ANN': Exp_ANN
}
...
Training_Models = ['Informer', 'Autoformer', 'FEDformer', 'ModernTCN', 'PatchTST', 'Crossformer', 'iTransformer', 'iInformer', 'iReformer', 'iFlowformer', 'NLinear', 'DLinear', 'MICN',
                   'TimesNet', 'LSTM', 'RNN', 'SCINet', 'Nbeats', 'UniTS_pretrain', 'UniTS_sup', 'ANN']
    ...
    def __init__(self, exp, args):
        ...
        if self.args.model in Training_Models:
            ...
            self.setting = '{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_at{}_fc{}_eb{}_dt{}_mx{}_{}_{}'.format(
                self.args.model, self.args.data_name, self.args.features,
    ...
    def test(self, itr=0):
        if self.args.model == 'UniTS_sup':
            ...
            self.setting = '{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_at{}_fc{}_eb{}_dt{}_mx{}_{}_{}'.format(
                ...
                self.args.attn, self.args.factor,
                self.args.embed, self.args.distil, self.args.mix, self.args.des, itr)
            self.exp.test(self.setting, load_pretrain=True)
        if self.args.model in Training_Models:
            print('>>>>>>>start testing : {}>>>>>>>>>>>>>>>>>>>>>>>>>>'.format(self.setting))
            self.setting = '{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_at{}_fc{}_eb{}_dt{}_mx{}_{}_{}'.format(
                self.args.model, self.args.data_name, self.args.features,
...
def create_model(
    ...
    if args.model not in UniqueData_Models:
        ...
        args.detail_freq = args.freq
        args.freq = args.freq[-1:]
    elif args.model in ['UniTS_pretrain', 'UniTS_sup']:
